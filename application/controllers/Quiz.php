...
=======
        // $this->load->model('quiz/Admin_model');
...
=======
                ...
                $sprize_img = "sprize_img" . time() . '.jpg';
                $config['upload_path'] = './uploads';
                $config['allowed_types'] = 'gif|jpg|png|jpeg';
                $config['max_size']    = '10000';
                $config['max_width']  = '3024';
                $config['max_height']  = '2024';
                $config['file_name'] = $sprize_img;
                $this->load->library('upload', $config);
                if (!$this->upload->do_upload('sprize_img')) 
                {
                    $data['status'] = 0;
                ...
                $tprize_img = "tprize_img" . time() . '.jpg';
                $config['upload_path'] = './uploads';
                $config['allowed_types'] = 'gif|jpg|png|jpeg';
                $config['max_size']    = '10000';
                $config['max_width']  = '3024';
                $config['max_height']  = '2024';
                $config['file_name'] = $tprize_img;
                $this->load->library('upload', $config);
                if (!$this->upload->do_upload('tprize_img')) 
                {
                    $data['status'] = 0;
                    $data['message'] = $this->upload->display_errors();
                }
...
<<<<<<< HEAD
        $this->load->view('admin/footers/admin_footer');
=======
        $this->load->view('quiz/footers/admin_footer');
    }
    public function manage_quiz_list()
    {
        $this->load->view('quiz/headers/admin_header');
    ...
    {
        $this->load->view('quiz/headers/admin_header');
        $this->load->view('quiz/manage_quiz_view');
        $this->load->view('quiz/footers/admin_footer');
>>>>>>> 5cba7fcaeb629355265634d296f7a00b5c659b87
    }
...
=======
                ...
                // redirect(base_url() . 'quiz/quiz_list');
