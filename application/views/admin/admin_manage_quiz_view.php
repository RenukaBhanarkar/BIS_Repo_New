<div class="container-fluid"> 
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage Quiz View</h1>
...
<div class="row">
    ...
    <div class="col-md-12 submit_btn p-3">
        ...
        <input type="submit" name="Approval" value="Approval" class="btn btn-success btn-sm text-white"id="approve">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure you want to Approval?</p>
                                </div>
